...
section .text   align=1                                                    ; Prevent auto-alignment
    ...
    resetStackoffset g1g2(0xF54,0,0x12EC)
    ...
    %endif
        push    ecx
        mov     edx, g1g2(edi,0,ebx)                                       ; New zCModelAni->name
    ...
    %endif
        ...
        mov     [ecx+0x4], eax
        cmp     eax, 0
    verifyStackoffset g1g2(0xF54,0,0x12EC)
        jg      g1g2(0x57A1EA,0,0x5994BB)                                  ; Continue
        push    0x1                                                        ; If refCtr <= 0 then
        call    zCModelAni__deleting_destructor
    addStack 4
    verifyStackoffset g1g2(0xF54,0,0x12EC)
        jmp     g1g2(0x57A1EA,0,0x5994BB)                                  ; Continue
