...
%ifidn __OUTPUT_FORMAT__, bin
    org     g1g2(0x57A17C,0,0,0x598065)
%endif
...
section .text   align=1                                                    ; Prevent auto-alignment
    ...
    resetStackoffset g1g2(0xF54,0,0,0x12D4)
        push    eax                                                        ; Existing zCModelAni *
        mov     ecx, [esp+stackoffset+g1g2(-0xF24,0,0,(-0x129C+0x10))]     ; zCModelPrototype *
        push    ecx
    ...
    %endif
        ...
        mov     [ecx+0x4], eax
        cmp     eax, 0
    verifyStackoffset g1g2(0xF54,0,0,0x12D4)
        jg      g1g2(0x57A1EA,0,0,0x5980CE)                                ; Continue
        push    0x1                                                        ; If refCtr <= 0 then
        call    zCModelAni__deleting_destructor
    addStack 4
    verifyStackoffset g1g2(0xF54,0,0,0x12D4)
        jmp     g1g2(0x57A1EA,0,0,0x5980CE)                                ; Continue
