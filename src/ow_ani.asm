...
%ifidn __OUTPUT_FORMAT__, bin
    org     g1g2(0x57D639,0,0,0x59C406)
%endif
...
section .text   align=1                                                    ; Prevent auto-alignment
    ...
    resetStackoffset g1g2(0xF54,0,0,0x1310)
        push    eax                                                        ; Existing zCModelAni *
        mov     ecx, [esp+stackoffset+g1g2(-0xF24,0,0,-0x12C8)]
        push    ecx
        mov     edx, [esp+stackoffset+g1g2(-0xF44,0,0,-0x12FC)]
        add     edx, 0x24
        ...
        mov     [ecx+0x4], eax
        cmp     eax, 0
    verifyStackoffset g1g2(0xF54,0,0,0x1310)
        jg      g1g2(0x57D8F8,0,0,0x59C6C3)                                ; Continue
        push    0x1                                                        ; If refCtr <= 0 then
        call    zCModelAni__deleting_destructor
    addStack 4
    verifyStackoffset g1g2(0xF54,0,0,0x1310)
        jmp     g1g2(0x57D8F8,0,0,0x59C6C3)
