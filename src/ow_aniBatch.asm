...
section .text   align=1                                                    ; Prevent auto-alignment
    ...
    resetStackoffset g1g2(0xF54,0x128C)
        push    eax                                                        ; Existing zCModelAni *
        mov     ecx, [esp+stackoffset+g1g2(-0xF24,-0x1244)]                ; zCModelPrototype *
        push    ecx
    %if GOTHIC_BASE_VERSION == 1
    ...
    %endif
        ...
        mov     [ecx+0x4], eax
        cmp     eax, 0
    verifyStackoffset g1g2(0xF54,0x128C)
        jg      g1g2(0x57A795,0x5987C4)                                    ; Continue
        push    0x1                                                        ; If refCtr <= 0 then
        call    zCModelAni__deleting_destructor
    addStack 4
    verifyStackoffset g1g2(0xF54,0x128C)
        jmp     g1g2(0x57A795,0x5987C4)                                    ; Continue
