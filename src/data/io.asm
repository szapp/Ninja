...
char_lego                db   'LEGO', 0
char_rb                  db   'rb', 0
char_g1g2                db   '_G', g1g2('1','112','2'), 0
char_bin                 db   '.BIN', 0
char_csl                 db   '.CSL', 0
...
NINJA_PATH_IKARUSSRC     db   '\NINJA\_INTERN\IKARUS\IKARUS_G', g1g2('1','112','2'), '.SRC', 0
NINJA_PATH_LEGOSRC       db   '\NINJA\_INTERN\LEGO\HEADER_G', g1g2('1','112','2'),'.SRC', 0
